...
import static hospital.Ho_BillsTable.billsTable;
import java.sql.Date;

public class Ho_Biils extends javax.swing.JFrame {

   Codes co =new Codes();
   public void display()
   {
       co.fillCombo("SELECT cus_no,name FROM customers ", billcomboBox, "name");
   }
    public Ho_Biils() {
        initComponents();
        display();
    ...
    private void initComponents() {
        ...
        billcomboBox = new RSMaterialComponent.RSComboBoxMaterial();
        ...
        jLabel5.setText("Bills Form");
        kGradientPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 10, 350, -1));
        ...
        billcomboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select Customer" }));
        kGradientPanel2.add(billcomboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 110, 270, -1));

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 30)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Description");
        kGradientPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 390, -1, -1));

        jLabel2.setFont(new java.awt.Font("Times New Roman", 1, 30)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Bill_Date");
        ...
        kGradientPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 100, -1, -1));

        rSTextFieldMaterial1.setBackground(new java.awt.Color(51, 0, 51));
        ...
        rSTextFieldMaterial1.setPlaceholder("Enter Decription");
        rSTextFieldMaterial1.setSelectionColor(new java.awt.Color(255, 255, 255));
        kGradientPanel2.add(rSTextFieldMaterial1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 380, 260, -1));
        kGradientPanel2.add(jDateChooser1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 280, 260, 40));
        ...
        rSTextFieldMaterial3.setPlaceholder("Enter Amount");
        rSTextFieldMaterial3.setSelectionColor(new java.awt.Color(255, 255, 255));
        kGradientPanel2.add(rSTextFieldMaterial3, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 180, 260, -1));

        getContentPane().add(kGradientPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 90, 560, 530));
    ...
    private void rSButtonMaterialIconOne4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonMaterialIconOne4ActionPerformed
        // TODO add your handling code here:
         ...
         String sql ="call bills_proc(null,(SELECT cus_no,name FROM customers where name='"+billcomboBox.getSelectedItem()+"'),'"+rSTextFieldMaterial3.getText()+"','"+dl+"','"+rSTextFieldMaterial1.getText()+"','insert')";
        co.setSql(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ho_Biils.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ho_Biils().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private RSMaterialComponent.RSComboBoxMaterial billcomboBox;
