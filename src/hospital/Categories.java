...
import static hospital.CategoriesTable.cattable;
...
public class Categories extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        categories = new RSMaterialComponent.RSTextFieldMaterial();
        ...
        categories.setBackground(new java.awt.Color(102, 0, 102));
        categories.setForeground(new java.awt.Color(255, 255, 255));
        categories.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        categories.setPhColor(new java.awt.Color(255, 255, 255));
        categories.setPlaceholder("Enter Categories");
        jPanel2.add(categories, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 150, -1, 40));
        ...
        jLabel1.setText("Categories Registeration Form");
    ...
    private void jLabel11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel11MouseClicked
        // TODO add your handling code here:
        String oper="insert";
        String sql="Call categories_proc(null,'"+categories.getText()+"','"+oper+"')";
        co.setSql(sql);
    ...
    private void jLabel10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel10MouseClicked
        // TODO add your handling code here:
        String oper="update";
        String sql="Call categories_proc('"+id+"','"+categories.getText()+"','"+oper+"')";
        co.setSql(sql);
        co.viewTable("SELECT * FROM `categories_view`", cattable);
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
        // TODO add your handling code here:
        try{
            String sql="SELECT * FROM `categories` WHERE cat_no='"+rSTextFieldMaterial3.getText()+"'";
            co.search(sql);
            if(co.rs.next())
            {
                id=co.rs.getString("cat_no");
                categories.setText(co.rs.getString("cat_name"));
                
            }
            else{
                JOptionPane.showConfirmDialog(null, "Xogtaada Lama Helin");
            }
    ...
    private RSMaterialComponent.RSTextFieldMaterial categories;
