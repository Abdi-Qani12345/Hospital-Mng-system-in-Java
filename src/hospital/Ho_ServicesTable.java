 ...
 * @author Abdiqani
 */
public class Ho_ServicesTable extends javax.swing.JFrame {

    /**
     * Creates new form Ho_ServicesTable
     */
    public Ho_ServicesTable() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        rSButtonMaterialGradientOne1.setText("Add-Service");
        ...
        jPanel1.add(rSButtonMaterialGradientOne1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1290, 70, 110, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ho_ServicesTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ho_ServicesTable().setVisible(true);
            }
        });
    }
