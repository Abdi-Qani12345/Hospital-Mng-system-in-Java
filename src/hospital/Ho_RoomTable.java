 ...
 * @author Abdiqani
 */
public class Ho_RoomTable extends javax.swing.JFrame {

   Codes co=new Codes();
   public void display()
   {
       co.viewTable("SELECT * FROM `rooms_view`", jTable1);
   }
    public Ho_RoomTable() {
        initComponents();
        display();
    ...
    private void initComponents() {
        ...
        rSButtonMaterialGradientOne1.setText("Add_Room");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ho_RoomTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ho_RoomTable().setVisible(true);
            }
        });
    }
