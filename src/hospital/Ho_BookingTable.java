 ...
 * @author Abdiqani
 */
public class Ho_BookingTable extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rSButtonMaterialGradientOne1.setText("Add_Booking");
        ...
        jPanel1.add(rSButtonMaterialGradientOne1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1280, 70, 120, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ho_BookingTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ho_BookingTable().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    public static final javax.swing.JTable booking = new javax.swing.JTable();
