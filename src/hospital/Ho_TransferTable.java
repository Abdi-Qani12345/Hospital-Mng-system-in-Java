 ...
 * @author Abdiqani
 */
public class Ho_TransferTable extends javax.swing.JFrame {

    /**
     * Creates new form Ho_TransferTable
     */
    public Ho_TransferTable() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        rSButtonMaterialGradientOne1.setText("Add-Transfer");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ho_TransferTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ho_TransferTable().setVisible(true);
            }
        });
    }
