 ...
 * @author Abdiqani
 */
public class Ho_LeavingTable extends javax.swing.JFrame {

    Codes co=new Codes();
    public void display()
    {
        co.viewTable("SELECT * FROM `leaving_view`", jTable1);
    }
    public Ho_LeavingTable() {
        initComponents();
        display();
    }
    ...
    private void initComponents() {
        ...
        rSButtonMaterialGradientOne1.setText("Add-Leaving");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ho_LeavingTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ho_LeavingTable().setVisible(true);
            }
        });
    }
