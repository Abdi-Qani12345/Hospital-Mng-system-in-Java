 ...
 * @author Abdiqani
 */
public class Ho_Transfer extends javax.swing.JFrame {

    /**
     * Creates new form Ho_Transfer
     */
    public Ho_Transfer() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Transfer Form");
        kGradientPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, 430, -1));
        ...
        kGradientPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 380, -1, -1));

        jLabel2.setFont(new java.awt.Font("Times New Roman", 1, 30)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("To_Room");
        kGradientPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 280, -1, -1));

        jLabel3.setFont(new java.awt.Font("Times New Roman", 1, 30)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("From_Room");
        ...
        kGradientPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, -1, -1));
        ...
        rSTextFieldMaterial1.setPlaceholder("Enter To-Room");
        rSTextFieldMaterial1.setSelectionColor(new java.awt.Color(255, 255, 255));
        kGradientPanel2.add(rSTextFieldMaterial1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 280, 260, -1));
        ...
        rSTextFieldMaterial4.setPlaceholder("Enter From-Room");
        ...
        kGradientPanel2.add(rSTextFieldMaterial4, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 190, 260, -1));
        kGradientPanel2.add(jDateChooser1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 380, 260, 40));

        rSComboBoxMaterial1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select Customer Name" }));
        kGradientPanel2.add(rSComboBoxMaterial1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 110, 250, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ho_Transfer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ho_Transfer().setVisible(true);
            }
        });
    }
