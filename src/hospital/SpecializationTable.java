...
public class SpecializationTable extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rSButtonMaterialGradientOne1.setText("Add_Specialization");
        ...
        jPanel1.add(rSButtonMaterialGradientOne1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1240, 50, 160, 50));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SpecializationTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SpecializationTable().setVisible(true);
            }
        });
    }
    ...
    public static final javax.swing.JTable spectable = new javax.swing.JTable();
