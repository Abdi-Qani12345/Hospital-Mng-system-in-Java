...
public class CategoriesTable extends javax.swing.JFrame {

    Codes co=new Codes();
    public void display()
    {
        co.viewTable("SELECT * FROM `categories_view`", cattable);
    }
    ...
    private void initComponents() {
        ...
        rSButtonMaterialGradientOne1.setText("Add_Categories");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CategoriesTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CategoriesTable().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    public static final javax.swing.JTable cattable = new javax.swing.JTable();
