 ...
 * @author Abdiqani
 */
public class Ho_CustomerTable extends javax.swing.JFrame {

   Codes co=new Codes();
   public void display()
   {
       co.viewTable("SELECT * FROM `customers_view`", jTable1);
   }
    public Ho_CustomerTable() {
        initComponents();
        display();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ho_CustomerTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ho_CustomerTable().setVisible(true);
            }
        });
    }
