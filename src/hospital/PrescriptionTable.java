...
public class PrescriptionTable extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rSButtonMaterialGradientOne1.setText("Add_Prescription");
        ...
        jPanel1.add(rSButtonMaterialGradientOne1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1250, 50, 150, 50));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrescriptionTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrescriptionTable().setVisible(true);
            }
        });
    }
    ...
    public static final javax.swing.JTable prescription = new javax.swing.JTable();
