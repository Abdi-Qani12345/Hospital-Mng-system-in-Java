 ...
 * @author Abdiqani
 */
public class Ho_ResponsibleTable extends javax.swing.JFrame {

    Codes co=new Codes();
    public void display()
    {
        co.viewTable("SELECT * FROM `responsibles_view`", jTable1);
    }
    public Ho_ResponsibleTable() {
        initComponents();
        display();
    }
    ...
    private void initComponents() {
        ...
        rSButtonMaterialGradientOne1.setText("Add_Responsible");
        ...
        jPanel1.add(rSButtonMaterialGradientOne1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1250, 70, 150, -1));
    ...
    private void rSButtonMaterialGradientOne1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonMaterialGradientOne1ActionPerformed
        // TODO add your handling code here:
        Ho_Responsible r=new Ho_Responsible();
        r.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ho_ResponsibleTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ho_ResponsibleTable().setVisible(true);
            }
        });
    }
