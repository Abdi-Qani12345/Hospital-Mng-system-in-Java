 ...
 * @author Abdiqani
 */
public class Ho_Customer_Service extends javax.swing.JFrame {

    /**
     * Creates new form Ho_Customer_Service
     */
    public Ho_Customer_Service() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Customer-Service Form");
        kGradientPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 20, 530, -1));
        ...
        rSComboBoxMaterial1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select Customer-Name" }));
        ...
        kGradientPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 380, -1, -1));

        jLabel3.setFont(new java.awt.Font("Times New Roman", 1, 30)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Customer_Name");
        kGradientPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 210, -1, -1));

        jLabel4.setFont(new java.awt.Font("Times New Roman", 1, 30)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Service_Name");
        ...
        rSTextFieldMaterial2.setPlaceholder("Search Description");
        rSTextFieldMaterial2.setSelectionColor(new java.awt.Color(255, 255, 255));
        kGradientPanel2.add(rSTextFieldMaterial2, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 380, 270, -1));
        ...
        kGradientPanel2.add(rSButtonMaterialIconOne2, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 470, 110, 40));
        ...
        kGradientPanel2.add(rSButtonMaterialIconOne3, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 470, 110, 40));

        rSButtonMaterialIconOne4.setText("Save");
        rSButtonMaterialIconOne4.setIcons(rojeru_san.efectos.ValoresEnum.ICONS.SAVE);
        kGradientPanel2.add(rSButtonMaterialIconOne4, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 470, 100, 40));

        rSComboBoxMaterial2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select Service-Name" }));
        kGradientPanel2.add(rSComboBoxMaterial2, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 130, 270, -1));

        jLabel6.setFont(new java.awt.Font("Times New Roman", 1, 30)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Service_Date");
        kGradientPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 300, -1, -1));
        ...
        rSTextFieldMaterial3.setPlaceholder("Search ID");
        rSTextFieldMaterial3.setSelectionColor(new java.awt.Color(255, 255, 255));
        kGradientPanel2.add(rSTextFieldMaterial3, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 30, 210, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ho_Customer_Service.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ho_Customer_Service().setVisible(true);
            }
        });
    }
